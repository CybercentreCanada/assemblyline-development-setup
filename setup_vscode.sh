...
sudo DEBIAN_FRONTEND=noninteractive apt install -y software-properties-common python3-launchpadlib
sudo -E DEBIAN_FRONTEND=noninteractive add-apt-repository -y ppa:deadsnakes/ppa
sudo DEBIAN_FRONTEND=noninteractive apt-get install -y python3-venv python3.11 python3.11-dev python3.11-venv
sudo DEBIAN_FRONTEND=noninteractive apt-get install -y libmagic1 libldap-common libsasl2-2 build-essential libldap2-dev libsasl2-dev libssl-dev
